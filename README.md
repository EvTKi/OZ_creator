...
project_root/
├── modules/
|   ├── __init__.py # Инициализация директории, как модуля для внедрения
...
├── tests/
|   ├── data/  # Перечень файлов для тестирования
|   ├── __init__.py # Инициализация директории, как модуля для внедрения
|   ├── test_logging_config.py # Модуль тестирования модуля logging_config.py
|   └── test_xlsx_parser.py # Модуль тестирования модуля xlsx_parser.py 
